        ...
        <table class="table table-striped">
            ...
            <? foreach ($people as $person) : ?>
                <tr>
                    ...
                    <td>
                        <?= $person->debate->title ? $person->debate->title : @text('UNCATEGORIZED'); ?>
                    </td>
                    <td>
                        <?= @helper('grid.enable', array('row' => $person)); ?>
                    </td>
                    <td>
                        <?= @helper('grid.enable', array('row' => $person, 'field' => 'featured')); ?>
                    </td>
                    <? if($person->isTranslatable()) : ?>
                        <td>
                            <?= @helper('com://admin/translations.template.helper.language.translations', array(
                                'row' => $person->id,
                                'table' => $person->getTable()->getName()
                            )); ?>
                        </td>
                    <? endif; ?>
                    <td>
                    ...
                    <td>
                        <?= @helper('date.humanize', array('date' => $person->created_on)) ?>
                    </td>
                    <td>
